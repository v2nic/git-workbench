...
export const useWorktreeAnimation = ({
  isHighlighted,
}: UseWorktreeAnimationProps): UseWorktreeAnimationReturn => {
  ...
  useEffect(() => {
    if (isHighlighted && !isAnimatingRef.current) {
      ...
      const timer3 = setTimeout(
        ...
        ANIMATION_DURATIONS.STAGE_1 +
          ANIMATION_DURATIONS.STAGE_2 +
          ANIMATION_DURATIONS.STAGE_3,
      );
  ...
  const getAnimationClass = useCallback(() => {
    ...
    switch (animationStage) {
      case 1:
        return "animate-worktree-highlight-1";
      case 2:
        return "animate-worktree-highlight-2";
      case 3:
        return "animate-worktree-highlight-3";
      case 4:
        return "animate-worktree-highlight-settle";
      default:
        return "";
    }
